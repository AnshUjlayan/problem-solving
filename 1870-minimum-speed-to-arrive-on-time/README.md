...
<p><l-core class="">Tests are generated such that the answer will not exceed</l-core> <code>10<sup>7</sup></code> and <code>hour</code> will have <strong>at most two digits after the decimal point</strong>.</p>
...
<l-core class=""><l-core class="">- Since we are already at an integer hour, we depart immediately at the 1 hour mark</l-core></l-core>. The second train takes 3/1 = 3 hours.
